...
the union of two hearts`,
  ...
  venue: {
    ...
    description: 'Follow the golden path to Ranch Retreat, where our families will be waiting to welcome you.',
  ...
  events: [
    {
      ...
      day: 'Thursday, 26 Nov',
      time: '7:00 PM CST',
      place: 'Family Home, Van Alstyne, Texas, USA',
  ...
  gratitude: {
    ...
    message: 'Your presence, prayers and affection make this beginning complete. We invite you once again to join us at Ranch Retreat, Van Alstyne, Texas on Saturday, 28 November 2026.',
  },
